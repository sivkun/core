...
describe('jquery.avatar tests', function() {
	...
	describe('url generation', function() {
		...
		it('default', function() {
			...
			expect(fakeServer.requests[0].url).toEqual('http://localhost/index.php/avatar/foo/32?requesttoken=%7Brequesttoken%7D');
		});
		...
		it('high DPI icon', function() {
			...
			expect(fakeServer.requests[0].method).toEqual('GET');
			expect(fakeServer.requests[0].url).toEqual('http://localhost/index.php/avatar/foo/128?requesttoken=%7Brequesttoken%7D');
		});
		...
		it('high DPI icon round up size', function() {
			...
			expect(fakeServer.requests[0].method).toEqual('GET');
			expect(fakeServer.requests[0].url).toEqual('http://localhost/index.php/avatar/foo/61?requesttoken=%7Brequesttoken%7D');
		});
	});
	...
	describe('valid avatar', function() {
		...
		it('default (no ie8 fix)', function() {
			...
			expect(img.src).toEqual('http://localhost/index.php/avatar/foo/32?requesttoken=%7Brequesttoken%7D');
		});
		...
		it('default high DPI icon', function() {
			...
			expect(img.height).toEqual(32);
			expect(img.width).toEqual(32);
			expect(img.src).toEqual('http://localhost/index.php/avatar/foo/61?requesttoken=%7Brequesttoken%7D');
		});
		...
		it('with ie8 fix', function() {
			...
			expect(img.height).toEqual(32);
			expect(img.width).toEqual(32);
			expect(img.src).toEqual('http://localhost/index.php/avatar/foo/32?requesttoken=%7Brequesttoken%7D#500');
		});
